...
public class Settings {
	...
	@Setter @Getter private ArrayList<ItemStack> generatingWhitelist = new ArrayList<ItemStack>();
	
	@Setter @Getter private String lang = "en";
	
	@Setter @Getter private boolean actionbarMessages = true;
	
	@Getter private Actions actions = new Actions();
	...
	@Setter @Getter private int generationCheckFrequency = 10;
	@Setter @Getter private int hologramUpdateFrequency = 20;
	@Setter @Getter private int guiUpdateFrequency = 20;
	
	@Setter @Getter private HashMap<ActionType, GeneratorAction> guis = new HashMap<ActionType, GeneratorAction>();
	
	@Setter @Getter private Sound placeSound = new Sound(XSound.BLOCK_ANVIL_LAND);
	@Setter @Getter private Sound pickupSound = new Sound(XSound.ENTITY_BAT_TAKEOFF);
	@Setter @Getter private Sound upgradeSound = new Sound(XSound.ENTITY_PLAYER_LEVELUP);
